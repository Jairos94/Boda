...
<body>
  ...
  <div class="container">
    ...
    <form action="" method="POST">
      ...
      <div class="vr"></div>
      <button type="button" class="btn btn-outline-danger">Limpiar pantalla</button>
    </form>
  </div>
  <div class="vr"></div>
    ...
    <tbody>
      ...
      try {
        ...
        if (isset($_POST['num'])) {
          ...
          $num = $_POST['numero'];
          $sql = "SELECT E.evnId,LP.lspId,p.psrId,CONCAT(p.psrNombre,' ',p.psrApellido1,' ',p.psrApellido2) AS Nombre,E.evnFecha,E.evrHoraInicio,E.evrHoraFinal,E.evnDescripcion,c.cfrDescripcion,E.evnUbicacion FROM evento E 
      ...
      ?>
          ...
          <tr>
            ...
            <th scope="row">
              <a href="<?php echo $row['evnUbicacion']; ?>">
                <img src="map.png">
              </a>
              <a href="#invitado_<?php echo $row['lspId']; ?>" class="btn btn-primary" data-bs-toggle="modal">
                Editar
              </a>
              <a href="#regalosinvitados" class="btn btn-primary" data-bs-toggle="modal">Lista de regalos</a>
            </th>
            <?php
